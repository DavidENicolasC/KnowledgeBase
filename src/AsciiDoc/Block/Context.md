Sometimes referred as the block name. Often implied by syntax, can be declared. Often determines the [[Content model]]. Used by converter to dispatch a convert method.
