When specified, is the declared block style. Is the first [[Positional Attribute]] in the in the [[Attribute List]]. Is the value the author supplies. Is then interpreted and resolved. This resolved block style specializes the block's context.
...
Supports a shorthand notation for defining the ID, role, and options attributes.