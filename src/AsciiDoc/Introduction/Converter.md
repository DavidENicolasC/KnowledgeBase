Uses the [[Context]] to dispatch a convert method. Then uses the [[src/AsciiDoc/Introduction/Block style]] to apply special behavior to blocks of the same family.
