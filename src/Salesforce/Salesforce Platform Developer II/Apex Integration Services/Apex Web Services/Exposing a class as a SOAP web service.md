Define your class as global. Add the webservice keyword and static to each method.

```
global with sharing class Example {
...
The external application can call your Apex methods by consuming the class WSDL file.1. From Setup, enter `Apex Classes` in the Quick Find box, then click **Apex Classes**.  
